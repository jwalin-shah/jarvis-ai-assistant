...
LABELS = {
    ...
    "fact_gs_0005": (
        ...
        "named_entity",
        "",
        "other participant's brother went to ER; fine now",
    ),
    ...
    "fact_gs_0008": (
        ...
        "other_participant",
        "",
        "lives ~20 min from UTD; has a brother; mom nearby",
    ),
    ...
    "fact_gs_0015": (
        ...
        "speaker",
        "",
        "mom is in India; has brother Mihir; mom coming back the 28th",
    ),
    ...
    "fact_gs_0022": (
        ...
        "named_entity",
        "",
        "dad and cousin work at Facebook and Intuit respectively",
    ),
    ...
    "fact_gs_0037": (
        ...
        "speaker",
        "",
        "in the hospital (from context: I'm kinda in the hospital)",
    ),
    ...
    "fact_gs_0040": (
        ...
        "speaker",
        "",
        "receiving drugs/antibiotics; inconclusive test results",
    ),
    "fact_gs_0041": (
        1,
        "relationship",
        ...
        "other_participant",
        "",
        "has a brother; dropping brother at SFO",
    ),
    "fact_gs_0042": (
        1,
        "education",
        ...
        "speaker",
        "",
        "planning to graduate fall 2024; discussing lease length with dad",
    ),
    ...
    "fact_gs_0057": (
        ...
        "other_participant",
        "",
        "on Virgin Mobile; switching to T-Mobile; dad found deal",
    ),
    ...
    "fact_gs_0068": (
        ...
        "",
        "",
        "main msg is 'i wanna grab u'; Queens location in context only",
    ),
    ...
    "fact_gs_0070": (
        ...
        "other_participant",
        "",
        "likes product management; seeking PM experience; uses Python and SQL for data science",
    ),
    ...
    "fact_gs_0080": (
        ...
        "other_participant",
        "",
        "deeply involved in Swadhyay/yuva kendra; values self-development",
    ),
    ...
    "fact_gs_0082": (
        ...
        "other_participant",
        "",
        "lives in San Jose area; has a sister",
    ),
    "fact_gs_0083": (
        1,
        "relationship",
        ...
        "speaker",
        "",
        "has brother who goes to school; drives to Napa for him",
    ),
    ...
    "fact_gs_0085": (
        ...
        "speaker",
        "",
        "prescription SER at CVS 43950 Pacific Common; Dr. J Moore",
    ),
    ...
    "fact_gs_0095": (
        ...
        "other_participant",
        "",
        "has a roommate at Stanford; gets along well",
    ),
    ...
    "fact_gs_0102": (
        ...
        "other_participant",
        "",
        "hates driving in SF; prefers taking BART",
    ),
    ...
    "fact_gs_0105": (
        ...
        "other_participant",
        "",
        "mom converted into their faith when younger in Taiwan; no longer tied to any faith",
    ),
    ...
    "fact_gs_0113": (
        ...
        "other_participant",
        "",
        "teaches a class; loves teaching",
    ),
    ...
    "fact_gs_0116": (
        ...
        "other_participant",
        "",
        "moved out from home; dad doing house projects",
    ),
    ...
    "fact_gs_0126": (
        ...
        "named_entity",
        "",
        "speaker's brother at culinary school; externship in Delaware",
    ),
    ...
    "fact_gs_0128": (
        ...
        "other_participant",
        "",
        "family member unwell; mom leaving for India",
    ),
    ...
    "fact_gs_0144": (
        ...
        "other_participant",
        "",
        "teaches Sanskrit on weekends; reads and meditates daily; works in engineering; involved in Swadhyay",
    ),
    "fact_gs_0145": (
        1,
        "preference",
    ...
    "fact_gs_0160": (
        ...
        "other_participant",
        "",
        "dad retiring; parents plan to sell house and travel in RV",
    ),
    ...
    "fact_gs_0171": (
        ...
        "speaker",
        "",
        "dad leaving for India on the 22nd; family ties to India",
    ),
    ...
    "fact_gs_0180": (
        ...
        "other_participant",
        "",
        "translates for mom at doctor appointments",
    ),
    ...
    "fact_gs_0182": (
        ...
        "other_participant",
        "",
        "dad turned 60; family trip to Egypt",
    ),
    ...
    "fact_gs_0187": (
        ...
        "speaker",
        "",
        "loved Harry Potter; read series ~25+ times",
    ),
    ...
    "fact_gs_0192": (
        ...
        "other_participant",
        "",
        "teaches at IHS; online teaching per bell schedule",
    ),
    ...
    "fact_gs_0194": (
        ...
        "other_participant",
        "",
        "works (off for xmas); brother in town",
    ),
    ...
    "fact_gs_0217": (
        ...
        "named_entity",
        "",
        "speaker's brother bakes/makes cakes",
    ),
    "fact_gs_0218": (
        1,
        "other",
    ...
    "fact_gs_0220": (
        ...
        "named_entity",
        "",
        "speaker's brother doing externship for culinary school",
    ),
    "fact_gs_0221": (
        1,
        "relationship",
        ...
        "other_participant",
        "",
        "has a sister; wants to bike across Golden Gate Bridge",
    ),
    ...
    "fact_gs_0228": (
        ...
        "speaker",
        "",
        "involved in Swadhyay; dad works; considering taking car to Dallas",
    ),
    "fact_gs_0229": (
        1,
        "location",
        ...
        "speaker",
        "",
        "planning to move back to California; looking for a job",
    ),
    ...
    "fact_gs_0231": (
        ...
        "other_participant",
        "",
        "likes Peter Zeihan books; interested in geopolitics",
    ),
    ...
    "fact_gs_0239": (
        ...
        "other_participant",
        "",
        "personality: hates letting people down",
    ),
    ...
    "fact_gs_0242": (
        ...
        "other_participant",
        "",
        "teaches Sanskrit on weekends; works in engineering; reads and meditates daily",
    ),
    ...
    "fact_gs_0250": (
        ...
        "other_participant",
        "",
        "teacher with pending return offer at a school; liked the school",
    ),
    ...
    "fact_gs_0255": (
        ...
        "speaker",
        "",
        "cousin brought 17 books; avid reader; has a brother",
    ),
    ...
    "fact_gs_0258": (
        ...
        "other_participant",
        "",
        "does daily 5K runs; has Xbox; dad made him pack it",
    ),
    ...
    "fact_gs_0262": (
        ...
        "other_participant",
        "",
        "romantic interest in someone; aspires to med school",
    ),
    ...
    "fact_gs_0281": (
        ...
        "speaker",
        "",
        "symptoms and vertigo recurring; depression",
    ),
    ...
    "fact_gs_0302": (
        ...
        "other_participant",
        "",
        "favorite shaak was okra growing up; mom packed roti for school lunch",
    ),
    ...
    "fact_gs_0304": (
        ...
        "speaker",
        "",
        "involved in Yuva Kendra and Swadhyay; questioning life purpose; slowly feeling better mentally",
    ),
    ...
    "fact_gs_0306": (
        ...
        "other_participant",
        "",
        "studies 30-40 moves of chess theory",
    ),
    "fact_gs_0307": (
        1,
        "health",
        ...
        "speaker",
        "",
        "bad sleep (4am again); depression; considering withdrawing; doing cardio/exercises",
    ),
    ...
    "fact_gs_0311": (
        ...
        "speaker",
        "",
        "recovering; dad involved in medical decisions; exercise regimen",
    ),
    ...
    "fact_gs_0322": (
        ...
        "other_participant",
        "",
        "lives in Kips Bay; works in Hudson Yards",
    ),
    ...
    "fact_gs_0330": (
        ...
        "speaker",
        "",
        "likes action movies; dad does too; mom doesn't",
    ),
    ...
    "fact_gs_0363": (
        ...
        "named_entity",
        "",
        "speaker's brother bakes; speaker eats whatever brother makes",
    ),
    ...
    "fact_gs_0366": (
        1,
        "health",
        "other_participant's dad",
        "named_entity",
        "",
        "dad was hospitalized for two weeks",
    ),
    ...
    "fact_gs_0372": (
        ...
        "named_entity",
        "",
        "brother doing culinary school externship in Delaware; speaker doing CrossFit all summer",
    ),
    ...
    "fact_gs_0377": (
        ...
        "other_participant",
        "",
        "dad lived in an RV for years; slept on sleeping bag when visiting",
    ),
    ...
    "fact_gs_0392": (
        ...
        "other_participant",
        "",
        "going through crisis: relationship break, uncle in coma, parents fighting/divorce, school stress, depression",
    ),
    ...
    "fact_gs_0399": (
        ...
        "other_participant",
        "",
        "goes rock climbing with brother",
    ),
