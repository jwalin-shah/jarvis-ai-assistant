...
LABELS = {
    ...
    "fact_gs_0003": (1, "work", "other_participant", "other_participant", "", "not currently working; follows coworkers on social media"),
    ...
    "fact_gs_0008": (1, "relationship", "other_participant", "other_participant", "", "has a brother"),
    ...
    "fact_gs_0018": (1, "relationship", "other_participant", "other_participant", "", "has dad and brothers; dad plays more (games)"),
    "fact_gs_0019": (0, "", "", "", "", "logistics; transient"),
    "fact_gs_0020": (1, "hobby", "other_participant", "other_participant", "", "can ski really well"),
    ...
    "fact_gs_0034": (1, "preference", "dad", "named_entity", "", "other participant's dad roots for Chiefs"),
    ...
    "fact_gs_0052": (1, "preference", "me", "speaker", "", "likes chocolate and peanut butter; never had Reese's"),
    "fact_gs_0053": (0, "", "", "", "", "no fact in main message; health facts in context only"),
    "fact_gs_0054": (1, "preference", "other_participant", "other_participant", "", "likes 100T esports team"),
    ...
    "fact_gs_0064": (1, "relationship", "other_participant", "other_participant", "", "likes someone"),
    "fact_gs_0065": (0, "", "", "", "", "vague; dad-in-RV fact is in context not main msg"),
    "fact_gs_0066": (1, "location", "me", "speaker", "", "moving in; mom will ship remaining stuff"),
    ...
    "fact_gs_0075": (1, "preference", "me", "speaker", "", "likes the city a lot; prefers UTD as school"),
    ...
    "fact_gs_0080": (1, "other", "me", "speaker", "", "celebrates Rakshabandhan; has street play practice"),
    ...
    "fact_gs_0087": (1, "preference", "other_participant", "other_participant", "", "likes grammar; only knows one language"),
    "fact_gs_0088": (0, "", "", "", "", "transient; school format speculation"),
    "fact_gs_0089": (0, "", "", "", "", "gaming stats"),
    "fact_gs_0090": (0, "", "", "", "", "no fact"),
    "fact_gs_0091": (0, "", "", "", "", "main msg is just intent; shrooms/edibles facts in context"),
    "fact_gs_0092": (1, "other", "me", "speaker", "", "family uses Sprint; dad comparing phone plans"),
    "fact_gs_0093": (0, "", "", "", "", "joke about address"),
    "fact_gs_0094": (0, "", "", "", "", "thanks"),
    "fact_gs_0095": (1, "relationship", "me", "speaker", "", "closest friend is the recipient; prefers talking to them over others"),
    ...
    "fact_gs_0103": (0, "", "", "", "", "reciprocating love; close relationship implied but no new fact"),
    ...
    "fact_gs_0111": (1, "health", "me", "speaker", "", "mental health struggles; head pain recurring"),
    ...
    "fact_gs_0118": (1, "other", "other_participant", "other_participant", "", "dad took the Civic to work; family owns Honda Civic"),
    ...
    "fact_gs_0125": (1, "health", "me", "speaker", "", "recovering from injury; exercise regimen 1min walk/1min run; dad involved in medical decisions; going to SLO and SB"),
    ...
    "fact_gs_0164": (1, "other", "me", "speaker", "", "personality: tends to repress emotions and feelings"),
    ...
    "fact_gs_0170": (1, "health", "me", "speaker", "", "ongoing head pressure; plays ultimate and basketball"),
    ...
    "fact_gs_0181": (1, "hobby", "me", "speaker", "", "wants to learn guitar; enjoys strumming random chords"),
    "fact_gs_0182": (1, "other", "other_participant", "other_participant", "", "getting iPhone X from parent (mama); dad flying it over"),
    "fact_gs_0183": (0, "", "", "", "", "vague; about reading content"),
    "fact_gs_0184": (0, "", "", "", "", "typo correction"),
    "fact_gs_0185": (1, "work", "other_participant", "other_participant", "", "has a job; picking up friends from airport"),
    "fact_gs_0186": (1, "preference", "other_participant", "other_participant", "", "likes Handsome Owl and James and Giant Peach sandwiches"),
    "fact_gs_0187": (0, "", "", "", "", "focal message 'from the mainland' too weak; beach house fact from context only"),
    "fact_gs_0188": (1, "hobby", "other_participant", "other_participant", "", "does yoga; physical issues needing stretching"),
    ...
    "fact_gs_0199": (0, "", "", "", "", "reaction wrapper (Disliked); fact in quoted text not focal message"),
