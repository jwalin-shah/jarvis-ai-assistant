...
def show_profiles():
    ...
    for chat_id, name in targets:
        ...
        print(f"  Relationship: {profile.relationship} ({profile.relationship_confidence*100:.1f}% confidence)")
        ...
        print(f"  Message Len:  Avg {profile.avg_message_length:.0f} chars ({profile.typical_length})")
