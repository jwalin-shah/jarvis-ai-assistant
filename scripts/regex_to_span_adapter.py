...
FOOD_WORDS = frozenset({
    "sushi", "pizza", "pasta", "tacos", "ramen", "burgers", "steak", "chicken",
    "salmon", "rice", "noodles", "bread", "cheese", "chocolate", "ice cream",
    "coffee", "tea", "beer", "wine", "curry", "soup", "salad", "fries",
    "bacon", "eggs", "fruit", "cake", "pie", "cookies", "donuts", "seafood",
    "shrimp", "lobster", "crab", "pho", "dim sum", "bbq", "barbecue",
    "cilantro", "avocado", "tofu", "hummus", "boba", "matcha", "smoothie",
    "burrito", "quesadilla", "sandwich", "wings", "ribs", "pork", "lamb",
    "vegetables", "veggies", "broccoli", "spinach", "kale", "mushrooms",
    "garlic", "onions", "peppers", "tomatoes", "potatoes", "corn",
    "mango", "banana", "strawberry", "blueberry", "apple", "orange",
    "peach", "watermelon", "grapes", "pineapple", "coconut",
    "pancakes", "waffles", "oatmeal", "cereal", "yogurt",
    "food", "meal", "snack", "dessert", "breakfast", "lunch", "dinner",
})
