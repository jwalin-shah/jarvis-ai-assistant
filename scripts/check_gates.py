...
def check_gates(results_dir: Path) -> dict[str, tuple[str, str]]:
    ...
    if coverage_file.exists():
        ...
        if coverage.get("skipped"):
            gates["G1"] = ("SKIP", coverage.get("reason", "benchmark skipped"))
        elif "coverage_at_70" in coverage:
            ...
            gates["G1"] = ("SKIP", "invalid coverage.json format")
    else:
    ...
    if memory_file.exists():
        ...
        if memory.get("skipped"):
            gates["G2"] = ("SKIP", memory.get("reason", "benchmark skipped"))
            ...
            gates["G2"] = ("SKIP", "invalid memory.json format")
    else:
    ...
    if hhem_file.exists():
        ...
        # Check if benchmark was skipped
        if hhem.get("skipped"):
            gates["G3"] = ("SKIP", hhem.get("reason", "benchmark skipped"))
            ...
            gates["G3"] = ("SKIP", "invalid hhem.json format")
    else:
    ...
    if latency_file.exists():
        ...
        if latency.get("skipped"):
            ...
            gates["G5"] = ("SKIP", "invalid latency.json format")
    else:
