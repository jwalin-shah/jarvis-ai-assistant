...
class TestSetupWizard:
    ...
    def test_run_check_only_no_config_created(
        ...
        with patch("jarvis.core.memory.get_memory_controller", return_value=mock_controller):
            wizard = SetupWizard(
    ...
    def test_memory_check_fallback_psutil(self, mock_console, monkeypatch):
        ...
        with patch("jarvis.core.memory.get_memory_controller", side_effect=ImportError):
            wizard = SetupWizard(console=mock_console)
            mode = wizard._check_memory()
