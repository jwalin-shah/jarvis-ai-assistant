...
| [Topic Segmentation](./design/TOPIC_SEGMENTATION.md) | Semantic boundary detection | ~180 |
...
| Classifier V2 | `jarvis/response_classifier_v2.py` | 3-layer hybrid, 10 response types |
| Topic Segmentation | `jarvis/topic_segmenter.py` | Semantic conversation chunking |
| Contact Profiles | `jarvis/contact_profile.py` | Per-contact style analysis |
