...
\* _Pre-existing failures tracked in `benchmarks/baseline.json` (currently 8)_
...
| --------------------- | ---------- | ---------- | ---- | ---------- | ---------- | ------ |
| Embedding (single)    | <100ms     | <200ms     | Hard | \_\_\_ms   | \_\_\_ms   | ⬜     |
| Embedding (batch 100) | <500ms     | <1000ms    | Soft | \_\_\_ms   | \_\_\_ms   | ⬜     |
| Generation (warm)     | <500ms     | <2000ms    | Hard | \_\_\_ms   | \_\_\_ms   | ⬜     |
| Generation (cold)     | <5000ms    | <10000ms   | Soft | \_\_\_ms   | \_\_\_ms   | ⬜     |
| Classification        | <50ms      | <100ms     | Hard | \_\_\_ms   | \_\_\_ms   | ⬜     |
| API Response          | <200ms     | <500ms     | Hard | \_\_\_ms   | \_\_\_ms   | ⬜     |
...
| ----------------------- | ---------- | ----------- | ----------- | -------------- | ------ |
| Batch Embedding (100)   | <1GB       | <500MB      | \_\_\_GB    | \_\_\_GB       | ⬜     |
| Generation (512 tokens) | <4GB       | <2GB        | \_\_\_GB    | \_\_\_GB       | ⬜     |
| Full Pipeline           | <6GB       | <3GB        | \_\_\_GB    | \_\_\_GB       | ⬜     |
| Startup                 | <2GB       | <1GB        | \_\_\_GB    | \_\_\_GB       | ⬜     |
...
| ----------------------------- | ------ | ------- | ------ | ------ |
| Messages/sec (classification) | >20    | >15     | \_\_\_ | ⬜     |
| Embeddings/sec                | >100   | >80     | \_\_\_ | ⬜     |
| Tokens/sec (generation)       | >50    | >40     | \_\_\_ | ⬜     |
| API RPS                       | >10    | >8      | \_\_\_ | ⬜     |
...
| Metric                     | Target       | Minimum | Actual  | Status |
| -------------------------- | ------------ | ------- | ------- | ------ |
| HHEM Score (hallucination) | ≥0.5         | ≥0.4    | \_\_\_  | ⬜     |
| Prompt Pass Rate           | ≥80%         | ≥75%    | \_\_\_% | ⬜     |
| RAG Retrieval Relevance    | ≥70% @ top-5 | ≥60%    | \_\_\_% | ⬜     |
| RAG Answer Accuracy        | ≥65%         | ≥55%    | \_\_\_% | ⬜     |
...
| ---- | ------------------ | ------ | ----------- | ------ | -------- | ------ |
| G1   | Model stack memory | <5.5GB | 5.5-6.5GB   | >6.5GB | \_\_\_GB | ⬜     |
| G2   | Mean HHEM score    | ≥0.5   | 0.4-0.5     | <0.4   | \_\_\_   | ⬜     |
| G3   | Warm-start latency | <3s    | 3-5s        | >5s    | \_\_\_s  | ⬜     |
| G4   | Cold-start latency | <15s   | 15-20s      | >20s   | \_\_\_s  | ⬜     |
...
| ------------------ | -------- | ----------- | ------ |
| Code Quality       | 20%      | \_\_\_%     | ⬜     |
| Tests              | 20%      | \_\_\_%     | ⬜     |
| Performance        | 20%      | \_\_\_%     | ⬜     |
| Documentation      | 10%      | \_\_\_%     | ⬜     |
| Migrations         | 10%      | \_\_\_%     | ⬜     |
| Observability      | 10%      | \_\_\_%     | ⬜     |
| Incident Readiness | 10%      | \_\_\_%     | ⬜     |
| **TOTAL**          | **100%** | **\_\_\_%** | ⬜     |
...
| --------------- | ---------- | ------- | ------ |
| Overall Score   | ≥90%       | \_\_\_% | ⬜     |
| Critical Gates  | 0 failures | \_\_\_  | ⬜     |
| Security Issues | 0 critical | \_\_\_  | ⬜     |
