...
class AblationResult:  # noqa: E402
    ...
    variant: str  # "categorized", "universal", "category_hint"  # noqa: E402
...
VARIANT_CONFIGS = {  # noqa: E402
    "categorized": {  # noqa: E402
        ...
        "system_prompt": None,  # Uses CATEGORY_CONFIGS  # noqa: E402
    },  # noqa: E402
    "universal": {  # noqa: E402
    ...
    "category_hint": {  # noqa: E402
        ...
        "system_prompt": "hint",  # Special marker  # noqa: E402
    },  # noqa: E402
}  # noqa: E402
  # noqa: E402
  # noqa: E402
def build_prompt_variant(  # noqa: E402
  ...
  # noqa: E402
        ...
        system = (  # noqa: E402
            ...
            f"Reply naturally as yourself, matching the {contact_style} style of the conversation. "  # noqa: E402
  ...
  # noqa: E402
  # noqa: E402
def generate_with_variant(  # noqa: E402
    generator,  # noqa: E402
    context: list[str],  # noqa: E402
    last_message: str,  # noqa: E402
    category: str,  # noqa: E402
    ...
    """Generate reply using specified variant. Returns (response, latency_ms)."""  # noqa: E402
    import time  # noqa: E402
  # noqa: E402
    prompt = build_prompt_variant(context, last_message, category, variant, contact_style)  # noqa: E402
  # noqa: E402
    ...
    latency_ms = (time.perf_counter() - start) * 1000  # noqa: E402
  # noqa: E402
    return result.text.strip(), latency_ms  # noqa: E402
  # noqa: E402
  # noqa: E402
def run_ablation(  # noqa: E402
    variant: str,  # noqa: E402
    examples: list[Any],  # noqa: E402
    judge_client: Any | None = None,  # noqa: E402
  ...
  # noqa: E402
    ...
    print(f"{'=' * 70}\n")  # noqa: E402
  # noqa: E402
    for i, ex in enumerate(tqdm(examples, desc=f"Running {variant}"), 1):  # noqa: E402
        # Generate response  # noqa: E402
        response, latency = generate_with_variant(  # noqa: E402
            loader,  # noqa: E402
  ...
  # noqa: E402
        ...
        anti_ai = check_anti_ai(response)  # noqa: E402
  # noqa: E402
        ...
        if judge_client:  # noqa: E402
            try:  # noqa: E402
                prompt = (  # noqa: E402
                    ...
                    'Respond: {"score": <0-10>, "reasoning": "<brief>"}'  # noqa: E402
                )  # noqa: E402
                ...
                judge_score = float(data["score"])  # noqa: E402
                judge_reasoning = data.get("reasoning", "")  # noqa: E402
            except Exception as e:  # noqa: E402
                judge_reasoning = f"judge error: {e}"  # noqa: E402
  # noqa: E402
        result = AblationResult(  # noqa: E402
            example_id=i,  # noqa: E402
            variant=variant,  # noqa: E402
            category=ex.category,  # noqa: E402
            generated_response=response,  # noqa: E402
  ...
  # noqa: E402
        ...
        judge_str = f" | Judge: {judge_score:.0f}/10" if judge_score else ""  # noqa: E402
        print(f"[{i:2d}] [{ex.category:12s}] {status}{judge_str} -> {response[:50]}")  # noqa: E402
  # noqa: E402
...
def main() -> int:  # noqa: E402
    parser = argparse.ArgumentParser(description="Categorization Ablation Study")  # noqa: E402
    parser.add_argument(  # noqa: E402
        "--variant",  # noqa: E402
        choices=["categorized", "universal", "category_hint", "all"],  # noqa: E402
        default="all",  # noqa: E402
        help="Which variant to run (default: all)",  # noqa: E402
    )  # noqa: E402
  ...
  # noqa: E402
    # Determine variants to run  # noqa: E402
    variants = (  # noqa: E402
  ...
  # noqa: E402
    ...
    for variant in variants:  # noqa: E402
        results = run_ablation(variant, examples, judge_client)  # noqa: E402
  ...
  # noqa: E402
    ...
    output_path = PROJECT_ROOT / "results" / "ablation_categorization.json"  # noqa: E402
