...
Usage:
    uv run python -m evals.benchmarks.quality --help
    uv run python -m evals.benchmarks.quality run --dataset standard
...
class HumanEvaluationIntegration:
    ...
    def import_human_evaluations(self, evaluation_file: Path) -> list[tuple[str, dict[str, float]]]:
        """Import human evaluations from a completed file.  # noqa: E402
