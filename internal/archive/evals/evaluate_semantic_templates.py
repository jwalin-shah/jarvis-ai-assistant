...
"""
        ...
        try:
            ...
            print(
                f"  ✓ Batch {i // batch_size + 1}/{(len(evaluations) + batch_size - 1) // batch_size} complete"  # noqa
            )
    ...
    if not args.skip_judge:
        ...
        if client:
            ...
            if evaluations:
                ...
                print(
                    f"   (Batch size: {args.batch_size}, Estimated time: {len(evaluations) // args.batch_size * 2.1:.0f}s)"  # noqa
                )
