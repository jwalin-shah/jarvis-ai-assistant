...
from evals.eval_pipeline import EVAL_DATASET_PATH, EvalExample, load_eval_dataset  # noqa
from evals.judge_config import JUDGE_MODEL, get_judge_client  # noqa
from tqdm import tqdm  # noqa

from models.loader import get_model  # noqa
...
def main():
    ...
    print(
        f"   Length: -{length_reduction:.0f} chars ({length_reduction / baseline_results['avg_length'] * 100:.0f}% shorter)"  # noqa
    )
