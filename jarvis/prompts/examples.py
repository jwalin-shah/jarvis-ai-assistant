"""Few-shot example data structures for prompt engineering.

This module contains all few-shot examples organized by use case:
- Reply generation (casual and professional)
- Summarization
- Search/QA
- Thread-specific examples (logistics, emotional support, planning, etc.)
- API examples
"""
