...
Reply:"""
    ...
    def generate_options(
        ...
        for response_type in OPTION_PRIORITY:
            ...
            # Strategy 3: Fallback template
            option = self._get_fallback_option(response_type)
            options.append(option)
