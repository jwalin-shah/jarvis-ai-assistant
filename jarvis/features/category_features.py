...
REACTION_PATTERNS_TUPLE = tuple(REACTION_PATTERNS)
...
class CategoryFeatureExtractor:
    ...
    def extract_hand_crafted(
        ...
        # Using startswith with a tuple is significantly faster than using a generator
        # expression with any()
        is_reaction_msg = 1.0 if text.startswith(REACTION_PATTERNS_TUPLE) else 0.0
