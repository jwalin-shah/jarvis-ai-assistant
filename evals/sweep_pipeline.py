...
from evals.dspy_reply import TRAIN_EXAMPLES, judge_metric, clean_reply
from evals.judge_config import JUDGE_MODEL, get_judge_client, get_judge_api_key
...
def run_eval(depth: int, instruction: str, examples: list, student_loader, rep_penalty: float = 1.05):
...
def main():
    ...
    print("=" * 70)
    print(f"PIPELINE SWEEP: ChatML + Repetition Penalty")
    print("=" * 70)
