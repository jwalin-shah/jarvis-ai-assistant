...
def get_suggestions(request: SuggestionRequest) -> SuggestionResponse:
    ...
    **Example Response:**
    ...
    Args:
        request: SuggestionRequest with last_message, num_suggestions, and optional group_size
    ...
    is_group_chat = request.group_size is not None and request.group_size >= 3
    ...
    if is_group_chat:
        for keywords, response, base_score in GROUP_RESPONSE_PATTERNS:
            ...
            if score > 0:
                ...
                if request.group_size and request.group_size >= 10:
    ...
    suggestions = [
        ...
        for text, score in scored[: request.num_suggestions]
    ]
