...
class StyleAnalyzer:
    ...
    def _analyze_formality(self, texts: list[str]) -> float:
        ...
        casual_words = {
            ...
            "nah", "bruh", "bro", "dude", "yo", "sup", "k", "u", "ur", "r",
        }

        # Formal indicators
        formal_words = {
            "please", "thank", "appreciate", "regards", "sincerely", "hello",
            "greetings", "certainly", "absolutely", "however", "therefore",
            "regarding", "concerning", "additionally", "furthermore",
        }
