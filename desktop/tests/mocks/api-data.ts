...
export const mockSummaryResponse = {
  ...
  key_points: ['Lunch planned for tomorrow', 'Meeting at noon', 'Location: usual place'],
  sentiment: 'positive',
...
export const mockDigestResponse = {
  ...
  summary: 'You had 15 conversations today. 3 require follow-up. Most active contact: John Doe.',
  highlights: [
    {
      type: 'unread',
      count: 5,
  ...
  for (let i = 0; i < count; i++) {
    ...
    messages.push({
      ...
      date_delivered: isFromMe
        ...
        : null,
      date_read: isFromMe ? new Date(Date.now() - (minutesAgo - 0.3) * 60000).toISOString() : null,
      is_system_message: false,
    });
  }
