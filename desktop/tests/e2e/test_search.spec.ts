...
test.describe('Search Functionality', () => {
  ...
  test('search filters conversations by name', async ({ mockedPage: page }) => {
    ...
    await expect(page.locator('.conversation')).toHaveCount(mockConversations.length);
  ...
  test('clearing search shows all conversations', async ({ mockedPage: page }) => {
    const searchInput = page.locator('.search input[type="text"]');
  ...
  test('search works with group conversation names', async ({ mockedPage: page }) => {
    const searchInput = page.locator('.search input[type="text"]');
  ...
  test('search preserves selection when filtering', async ({ mockedPage: page }) => {
