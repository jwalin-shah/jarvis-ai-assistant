...
test.describe('Conversation List', () => {
  ...
  test('displays conversation names correctly', async ({ mockedPage: page }) => {
    await page.waitForSelector('.conversation');
  ...
  test('identifies group conversations with icon', async ({ mockedPage: page }) => {
    await page.waitForSelector('.conversation');
  ...
  test('shows initials for non-group conversations', async ({ mockedPage: page }) => {
    await page.waitForSelector('.conversation');
  ...
  test.skip('only one conversation can be selected at a time', async ({ mockedPage: page }) => {
    // NOTE: This test is skipped due to click interaction timing issues.
