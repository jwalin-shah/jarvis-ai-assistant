...
test.describe('Message View', () => {
  ...
  test('shows placeholder when no conversation selected', async ({ mockedPage: page }) => {
  ...
  test('displays messages when conversation is selected', async ({ mockedPage: page }) => {
  ...
  test('distinguishes sent vs received messages', async ({ mockedPage: page }) => {
    await selectConversation(page, 'John Doe');
    await page.waitForSelector('.message');
  ...
  test('displays sender name for received messages', async ({ mockedPage: page }) => {
    await selectConversation(page, 'John Doe');
    await page.waitForSelector('.message');
  ...
  test('shows conversation header with recipient info', async ({ mockedPage: page }) => {
    await selectConversation(page, 'John Doe');
  ...
  test('loads different messages for different conversations', async ({ mockedPage: page }) => {
  ...
  test('shows group chat messages with multiple senders', async ({ mockedPage: page }) => {
  ...
  test('scrolls to bottom when loading messages', async ({ mockedPage: page }) => {
    await selectConversation(page, 'John Doe');
    await page.waitForSelector('.message');
    ...
    const isAtBottom =
      scrollInfo.scrollTop + scrollInfo.clientHeight >= scrollInfo.scrollHeight - 10;
