...
<div class="controls">
  <div class="controls-left">
    <div class="search-box">
      ...
      />
      {#if searchQuery}
        <button class="clear-search" on:click={() => { searchQuery = ""; handleSearch(); }} aria-label="Clear search">
          &times;
        </button>
      {/if}
    </div>

    <select class="layout-select" value={currentLayout} on:change={handleLayoutChange} aria-label="Select layout">
    ...
    <div class="relationship-filters">
      {#each relationshipTypes as type}
        <button
          ...
          aria-pressed={selectedRelationships.includes(type)}
        >
          {type}
        </button>
      {/each}
  ...
  <div class="controls-right">
    <button class="control-btn" on:click={() => dispatch("resetZoom")} aria-label="Reset Zoom" title="Reset Zoom">
    ...
    <button class="control-btn" on:click={() => dispatch("reheat")} aria-label="Reheat Simulation" title="Reheat Simulation">
      <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true">
    ...
    <button class="control-btn export" on:click={() => dispatch("export", "png")} aria-label="Export Graph as PNG" title="Export">
      <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true">
