...
<div class="controls">
  ...
  <div class="controls-center">
    <div class="relationship-filters">
      ...
      {#if selectedRelationships.length > 0}
        <button class="clear-filters" on:click={clearFilters} aria-label="Clear filters">Clear</button>
      {/if}
    </div>
  </div>
  ...
  <div class="controls-right">
    ...
    <button class="control-btn export" on:click={() => dispatch("export", "png")} title="Export" aria-label="Export graph">
      <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
